...
export class AdminAccountComponent {
  ...
  SearchAccount() {
    if (this.page < 0) {
      ...
      this.http.get<any>('https://localhost:44343/api/Employee/Search_Employee/' + this.size + ',' + this.page + '?keyword=' + this.keyword)
      .subscribe(
        result => {
                    var res: any = result;
                    if (res != null) {
  ...
  CreateAccount(){
    this.http.post('https://localhost:44343/api/Employee/Create_Employee', this.account)
    .subscribe(
      result => {
                  var res:any = result;
                  if (res != null) {
  ...
  DeleteAccount(account){
    ...
    if (check == true) {
      this.http.delete('https://localhost:44343/api/Employee/Delete_Employee/' + account)
      .subscribe(
        result => {
                    var res: any = result;
                    if (res != null){
  ...
  UpdateAccount(){
    this.http.put('https://localhost:44343/api/Employee/Update_Employee/' + this.account.account, this.account)
    .subscribe(
      result => {
                  var res:any = result;
                  if (res != null) {
